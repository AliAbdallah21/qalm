...
import { addCertificateAction } from '@/features/profile/actions'
...
export async function POST(request: Request) {
    try {
        ...
        const result = await addCertificateAction(body)
        ...
        console.error('[/api/profile/certificates POST]', error)
